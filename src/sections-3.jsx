      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
        ...
        <div style={{ display: 'grid', gap: 16 }}>
          {[
            ...
            <div key={i} style={{
              background: 'var(--carvao-med)', padding: '24px 28px',
              ...
              <div style={{ fontFamily: 'var(--f-corpo)', fontSize: 15, color: 'rgba(255,255,255,.7)', marginTop: 8, lineHeight: 1.6 }}>{b.d}</div>
              <div style={{
                marginTop: 16,
                fontFamily: 'var(--f-display)', fontStyle: 'italic', fontWeight: 900,
                fontSize: 14, color: 'var(--carvao)',
                background: 'var(--dourado)', padding: '6px 14px',
